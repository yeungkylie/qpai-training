...
ground_truth2, prediction2 = get_gt_and_prediction(test_data, "Heterogeneous 0-100", "noised")
...
ax.plot(x, prediction3, color='r', label="High Resolution (Smoothed)", alpha=0.5)
