...
oxy_vals, pred1 = get_gt_and_prediction_discrete(test_data, "Acoustic", "smoothed")
oxy_vals, pred2 = get_gt_and_prediction_discrete(test_data, "Skin", "thresholded_smoothed")
