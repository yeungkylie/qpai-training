...
if __name__ == "__main__":
    # SET_NAME = "heterogeneous"
    # IN_PATH = f"D:/learned spectral unmixing/{SET_NAME}/"
    # OUT_FILE = f"D:/learned spectral unmixing/datasets/{SET_NAME}/{SET_NAME}.npz"
    SET_NAME = "test extraction"
    IN_PATH = f"D:/Kylie Simulations/{SET_NAME}/"
    OUT_FILE = f"D:/Kylie Simulations/datasets/{SET_NAME}/{SET_NAME}.npz"
