...
# path_manager = PathManager("path_config_single_vessel_water.env")
...
for melanin_fraction in MELANIN_LEVELS:
    for oxygen_fraction in OXYGEN_LEVELS:
        ...
        VOLUME_NAME = f"Test_Data_SingleVesselInWater_{n_sample}_oxy_{oxygen_fraction:.2f}_mel_{melanin_fraction:.3f}"
        VISUALIZE = True
        general_settings = {
