...
temp = 'I:/research\seblab\data\group_folders\Kylie\Baseline/Flowphantom_inVision_700_900_5_Water_ 505.hdf5'
...
for i in range(505, 506):
    print(i)
    if i < 10:
        filename = 'I:/research\seblab\data\group_folders\Kylie\Baseline/Flowphantom_inVision_700_900_5_Water_' + str(i) + '.hdf5'
    elif i < 100:
        filename = 'I:/research\seblab\data\group_folders\Kylie\Baseline/Flowphantom_inVision_700_900_5_Water_' + str(i) + '.hdf5'
    else:
        filename = 'I:/research\seblab\data\group_folders\Kylie\Baseline/Flowphantom_inVision_700_900_5_Water_' + str(i) + '.hdf5'
